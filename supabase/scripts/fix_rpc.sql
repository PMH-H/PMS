-- Force recreate RPC to ensure cache invalidation works
...
-- Also verify get_admin_metrics perms while we are here
GRANT SELECT ON admin_metrics_summary TO authenticated;
GRANT SELECT ON admin_metrics_summary TO service_role;
